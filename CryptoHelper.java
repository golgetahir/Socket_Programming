...
public class CryptoHelper {
	...
	// METHODS
	public boolean verifySignature(byte[] cert, byte[] signature, String ca,byte[] pk) {
		ByteBuffer bb_key = ByteBuffer.allocate(LEN_KEY);
		bb_key.putLong(PK_SERVER);
		byte[] part2 = bb_key.array();
		System.out.println("PUBLIC ORIJI = " + new String(part2));
		System.out.println(Arrays.equals(pk, part2));
